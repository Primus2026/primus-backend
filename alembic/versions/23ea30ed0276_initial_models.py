...
Revision ID: 23ea30ed0276
Revises: 
Create Date: 2026-01-03 17:56:46.930022
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('alert_type', sa.Enum('TEMP', 'WEIGHT', 'EXPIRY', 'THEFT', name='alerttype'), nullable=False),
